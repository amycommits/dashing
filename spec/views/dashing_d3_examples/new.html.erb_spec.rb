...
RSpec.describe "dashing_d3_examples/new", type: :view do
  before(:each) do
    assign(:dashing_d3_example, DashingD3Example.new(
      :name => "MyString",
      :title => "MyString",
      :cx => 1,
      :cy => 1,
  ...
  it "renders new dashing_d3_example form" do
    render

    assert_select "form[action=?][method=?]", dashing_d3_examples_path, "post" do
